...
const Events: EventType[] = [
  ...
  { id: "6", year: "2019", title: "The Age of Smupid", image: "/images/history/2019.jpg"},
  { id: "7", year: "2018", title: "Elephant in The Room", image: "/images/history/2018.jpg"},
  { id: "8", year: "2017", title: "Break The Pattern", image: "/images/history/2017.jpg"},
  { id: "9", year: "2016", title: "Frameworks", image: "/images/history/2016.jpg"},
];
...
export default function Timeline({ events = Events }: { events?: EventType[] }) {
  return (
    <section className="max-w-7xl mx-auto px-6 py-10">
      ...
      {/* GRID */}
      <div className="grid sm:grid-cols-2 lg:grid-cols-2 gap-15">
        {events.map((ev, index) => (
